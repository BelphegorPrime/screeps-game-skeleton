            ...
            _.map(spawns, spawn => {
                if (room.name === spawn.room.name) {
                    ...
                    if (_.size(littleCreeps) < settings.numberLittleCreeps) {
                        ...
                        let newName = spawn.createCreep([WORK, CARRY, MOVE], "LittleCreep-" + creepNumber + "|" + generalFunctions.getRandomID(), { role: settings.generalSettings.roles.harvester, type: "little" });
                    ...
                    if (room.canBuildMediumCreep && _.size(mediumCreeps) < settings.numberMediumCreeps) {
                        ...
                        let newName = spawn.createCreep([WORK, WORK, WORK, WORK, CARRY, MOVE, MOVE], "MediumCreep-" + mediumCreepNumber + "|" + generalFunctions.getRandomID(), { role: settings.generalSettings.roles.harvester, type: "medium" });
                    ...
                    if (room.canBuildBigCreep && _.size(bigCreeps) < settings.numberBigCreeps) {
                        ...
                        let newName = spawn.createCreep([WORK, WORK, WORK, WORK, WORK, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE], "BigCreep-" + bigCreepNumber + "|" + generalFunctions.getRandomID(), { role: settings.generalSettings.roles.harvester, type: "big" });
